...
#define ZCSetRight(value) self.right = value
#define ZCSetBottom(value) seif.bottom = value
#define ZCSetTop(value) self.top = value
#define ZCsetLeft(value) self.left = value
/** 设置控件x */
